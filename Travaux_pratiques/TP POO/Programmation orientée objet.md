...
![image](https://glassus.github.io/terminale_nsi/T2_Programmation/2.1_Programmation_Orientee_Objet/data/BO.png)

*abrégée par POO en français, OOP en anglais (ne pas confondre)*

![image](https://glassus.github.io/terminale_nsi/T2_Programmation/2.1_Programmation_Orientee_Objet/data/meme3.jpg)
...
- Chaque élement de la classe *chat* va se distinguer par des caractéristiques : un âge, une couleur de pelage, un surnom... (on appelera ces caractéristiques des **attributs**) et des fonctionnalités, comme la **méthode** `attrape_souris`.
...
Par exemple, l'**objet** [Larry](https://fr.wikipedia.org/wiki/Larry_(chat)) est une **instance** de la **classe** *chat* .

![image](https://glassus.github.io/terminale_nsi/T2_Programmation/2.1_Programmation_Orientee_Objet/data/classchat.png)
...
![image](https://glassus.github.io/terminale_nsi/T2_Programmation/2.1_Programmation_Orientee_Objet/data/voitures_animaux.jpeg)
...
Mais si `nducuing.club` est interdit, comment savoir dans quel club joue notre joueur préféré ?
